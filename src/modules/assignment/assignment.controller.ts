...
export class AssignmentController {
  ...
  public async getClassRoomAssignments(
  ...
  async getAssignmentsByStudentEmail(
    @Param("studentEmail") studentEmail: string,
  ) {
    return await this.assignmentService.getAssignmentsByStudentEmail(
      studentEmail,
    );
  }
  ...
  async updateAssignmentById(
    ...
    return await this.assignmentService.updateAssignmentById(
      assignmentId,
      updateAssignmentDto,
    );
  }
